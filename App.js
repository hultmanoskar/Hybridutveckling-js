...
export default function App() {
  ...
  return (
   <View style={main.container}>
      ...
      <Text style={{ fontWeight: "bold", fontSize: 50, marginTop:10, backgroundColor:"lightblue", }}>Hello World! </Text>
      <Text style={{fontSize:20, fontWeight: 'bold', backgroundColor:"lightblue"}}>First React Native app </Text>
      <Text style={{backgroundColor: "lightblue",}}>"This is a paragraph explaining what this app is all about. As you can see there are already many components including text, images and buttons.</Text>
